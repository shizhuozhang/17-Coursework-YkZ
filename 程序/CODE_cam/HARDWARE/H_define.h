...
#define __MPU6500  1//使能9250的同时，还要使能IO口中的ELSE，其中定义了9250的片选
					//不用9250时，要把mpu9250.c和ahrs.c文件从工程中移除
...
//#define D_ADC1 ADC1->DR&0xFFFF
//#define D_ADC2 (ADC1->DR&0xFFFF0000)>>16
#define   G   9.8
///////////////////////////////////////////////////////////////////////////////////
...
extern volatile Angle_XYZ  Angle_Exp;
extern float Angle_Init[3];
extern PID_IncrementType  PID_Pitch;
extern PID_IncrementType  PID_Yaw;	//外环：角度PID环
